...
function icb_install(){
    ...
    $tbl_icb_email = "{$wpdb->prefix}icb_email";
    $tbl_icb_email_setting = "{$wpdb->prefix}icb_email_setting";
    $sql .= "CREATE TABLE " . $tbl_icb_email  . " (
...
function icb_install_data(){
    ...
    $tbl_icb_topics  = "{$wpdb->prefix}icb_topics";
    $topic_data = array(
            array('topic' => 'UVLe','email'=>'','stat' => 'Active'),
            array('topic' => 'MPM-RD (OVLe)','email'=>'','stat' => 'Active'),
            array('topic' => 'Trainining, Seminar or Workshop','email'=>'','stat' => 'Active'),
            array('topic' => 'Internship Program','email'=>'','stat' => 'Active'),
            array('topic' => 'Other Services','email'=>'','stat' => 'Active'),
            array('topic' => 'Other Concerns','email'=>'','stat' => 'Active')
        );
...
// //Tables
include_once (plugin_dir_path(__FILE__)  . '/tables/Subscribe_table_class.php');
