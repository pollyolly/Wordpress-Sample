...
/**
 * Template Name: Parangal sa Mag-aaral 2020 - Livestream
 * by ilc.upd.edu.ph
 */
		...
		<div class="column-one display-inline">
			<div class="youtube-embed">
				<iframe width="100%" height="713"
        				src="https://www.youtube.com/embed/AbcgNy2pIXk"
        				frameborder="0"
			...
			<div class="streaming-description">
				<br>
				<p>
					<b style="color:#800000; font-size: 28px;">Parangal sa Mag-aaral</b>
				</p>
				<p style="color:#252525;">
					<span style="font-style:italic; color:#646464">Ika-26 ng Pebrero 2020 <br>
                                        University Theater, UP Diliman</span>
				</p>
                                <hr>
                                <div style="">
                                <br>
