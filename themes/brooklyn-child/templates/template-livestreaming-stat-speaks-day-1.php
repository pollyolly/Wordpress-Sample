...
/**
 * Template Name: Stat Speaks Day 1 - Livestream
 * by ilc.upd.edu.ph
 */
	...
	<div class="streaming-container">
		<div class="column-one display-inline">
			<div class="youtube-embed">
				<!-- Livestream1: https://www.youtube.com/embed/8aoe7m1ugrI -->
				<iframe
					width="560"
					height="315"
			...
			<div class="streaming-description">
				<br>
				<p>
					<b style="color:#800000; font-size: 28px;">Stat Speaks</b>
				</p>
				<p style="color:#252525;">
					Colloquium on the Statistical Sciences<br><br>
					<span style="font-style:italic; color:#646464">January 16, 2020 (Thursday)<br>
					4:00pm - 6:00pm Lecture Hall 1</span>
					<br><br>
					<!-- a href="https://ilc.upd.edu.ph/livestream-2">Day 2 Livestream</a -->
				</p>
                                <hr>
                                <div style="">
                                <br>
